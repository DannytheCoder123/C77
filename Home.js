        ...
        return (
            <View style={styles.container}>
                ...
                {<ImageBackground
                    ...
                    <TouchableOpacity
                        style={styles.routeCard} onPress={() => this.props("SpaceCraft")}> 
                        </TouchableOpacity>
                        <TouchableOpacity> 
                         ...
                         <TouchableOpacity> style={styles.routeCard} onPress={() => this.props.navigation.navigate("StarMap")}
                            ...
                            <TouchableOpacity> style={styles.routeCard} onPress={() => this.props.navigation.navigate("Tonightsky")}/</TouchableOpacity>
